...
export const seedProducts = [
  ...
  },
  {
    ...
    features: [], // Electro-pneumatic: air bulb actuates remote electrical snap switch
    flagship: false,
...
export const seedOptions = [
  ...
  },
  {
    ...
    description: 'Cranes, conveyors, heavy equipment',
    icon: 'HardHat',
    parentCategory: 'industrial',
    sort_order: 3,
  },
  {
    ...
    description: 'Power, water, waste management',
    icon: 'Zap',
    parentCategory: 'industrial',
    sort_order: 4,
  },
  {
    ...
    description: 'Farming, food processing, packaging',
    icon: 'Wheat',
    parentCategory: 'industrial',
    sort_order: 5,
  },
  {
    ...
    description: 'Military, aerospace, telecom',
    icon: 'Shield',
    parentCategory: 'industrial',
    sort_order: 6,
  },
  ...
  // Technology Options
  {
    ...
    icon: 'Zap',
    available_for: ['industrial', 'automotive', 'construction', 'utilities', 'agriculture', 'defense', 'tattoo', 'general'],
    sort_order: 1,
  },
  {
    id: 'tech-pneumatic',
    ...
    icon: 'Wind',
    available_for: ['industrial', 'automotive', 'construction', 'utilities', 'agriculture', 'defense', 'general'],
    sort_order: 2,
  },
  {
    id: 'tech-wireless',
