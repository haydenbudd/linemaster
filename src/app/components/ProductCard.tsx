...
export function ProductCard({ product, matchReasons }: ProductCardProps) {
  const dutyColors = {
    ...
    medium: { 
      bg: 'from-blue-100 to-blue-50 dark:from-blue-950 dark:to-blue-900', 
      badgeBg: 'bg-blue-700 dark:bg-blue-600',
      text: 'text-white'
    },
    light: { 
      bg: 'from-teal-100 to-teal-50 dark:from-teal-950 dark:to-teal-900', 
  ...
  return (
    <div className="bg-card rounded-2xl border border-border shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-[1.02] overflow-hidden group">
      {/* Badges */}
      <div className="flex gap-2 p-4 bg-gradient-to-r from-accent/50 to-transparent">
        {product.flagship && (
          <div className="flex items-center gap-1.5 px-3 py-1.5 bg-gradient-to-r from-orange-500 to-amber-500 text-white text-xs font-bold uppercase tracking-wider rounded-full shadow-md">
            <Sparkles className="w-3.5 h-3.5" />
            Flagship
          </div>
        )}
        <div className="px-3 py-1.5 bg-gradient-to-r from-primary/10 to-primary/5 text-primary text-xs font-bold uppercase tracking-wider rounded-full border border-primary/20">
          {product.ip}
        </div>
      </div>
      ...
      <div className="p-6">
        ...
        <div className="flex flex-wrap gap-2 mb-6">
          <span className={`px-3 py-1.5 text-xs font-bold uppercase tracking-wider rounded-full ${dutyColor.badgeBg} ${dutyColor.text}`}>
            {product.duty}
          </span>
        ...
        <a
          ...
          className="flex items-center justify-center gap-2 w-full px-6 py-3.5 bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 text-primary-foreground font-bold rounded-xl transition-all shadow-md hover:shadow-xl group"
        >
